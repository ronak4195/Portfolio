    ...
    return (
        <div className='contactBox'>
            ...
            <form  onSubmit={onSubmit} className="contactCard">
                    <input className="name inputBar" type="text" placeholder="Your Name" />
                    <input className="email inputBar" type="email" placeholder="Your Email" />
                    <textarea className="message" placeholder="Your Message"></textarea>
                    <div className="sendButton"><button className='button'>Send Message</button></div>
            </form>
            <span>{result}</span>
        </div>
    );
